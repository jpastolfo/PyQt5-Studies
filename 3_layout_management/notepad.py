...
# -*- coding: utf-8 -*-
"""
The basic notepad GUI consists of three widgets. Users will be able to clear the text, edit text and save the text to a file.
...
class Notepad(QWidget):
    ...
    def clearText(self):
        """
        If the new button is clicked, display a dialog asking user if they want to
        clear the text edit field or not.
    ...
    def saveText(self):
        """
        If the save button is clicked, display dialog to save the text in the text
        edit field to a text file.
